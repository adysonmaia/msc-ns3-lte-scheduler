...
public:
	 ...
	 */
	M2mUdpEchoClientHelper(Address ip, uint16_t port);
	M2mUdpEchoClientHelper(Ipv4Address ip, uint16_t port);
	M2mUdpEchoClientHelper(Ipv6Address ip, uint16_t port);
